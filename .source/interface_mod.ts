...
(function () {
  ...
  function buildCss(settings) {
    ...
    return ''
      ...
      + 'body[data-ifx-enabled="1"] .full-start__buttons,body[data-ifx-enabled="1"] .full-start-new__buttons{position:relative;gap:10px;}'
      + 'body[data-ifx-enabled="1"] .full-start__buttons .button,body[data-ifx-enabled="1"] .full-start-new__buttons .button,body[data-ifx-enabled="1"] .full-start__buttons .full-start__button,body[data-ifx-enabled="1"] .full-start-new__buttons .full-start__button{border-radius:18px;border:1px solid rgba(255,255,255,.08);background:linear-gradient(180deg,rgba(255,255,255,.06),rgba(255,255,255,.02));box-shadow:0 10px 26px rgba(0,0,0,.22);transition:transform .18s ease,box-shadow .18s ease,border-color .18s ease;}'
      + 'body[data-ifx-enabled="1"][data-ifx-compact="1"] .full-start__buttons .button,body[data-ifx-enabled="1"][data-ifx-compact="1"] .full-start-new__buttons .button,body[data-ifx-enabled="1"][data-ifx-compact="1"] .full-start__buttons .full-start__button,body[data-ifx-enabled="1"][data-ifx-compact="1"] .full-start-new__buttons .full-start__button{padding-top:10px;padding-bottom:10px;min-height:46px;}'
      + 'body[data-ifx-enabled="1"] .full-start__buttons .button.focus,body[data-ifx-enabled="1"] .full-start-new__buttons .button.focus,body[data-ifx-enabled="1"] .full-start__buttons .full-start__button.focus,body[data-ifx-enabled="1"] .full-start-new__buttons .full-start__button.focus{transform:translateY(-2px);border-color:var(--ifx-accent-edge);box-shadow:0 0 0 4px var(--ifx-accent-soft),0 16px 28px rgba(0,0,0,.26);}'
