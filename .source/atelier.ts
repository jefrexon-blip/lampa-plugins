...
(function () {
  ...
  function buildCss(settings) {
    ...
    return ''
      + ':root{--ifx-accent:' + accent.main + ';--ifx-accent-soft:' + accent.soft + ';--ifx-accent-edge:' + accent.edge + ';--ifx-card-radius:22px;--ifx-chip-radius:999px;--ifx-shadow:0 22px 48px rgba(0,0,0,.32);--ifx-line:rgba(255,255,255,.07);--ifx-panel:rgba(18,21,28,.72);--ifx-panel-strong:rgba(12,15,20,.84);--ifx-text-soft:rgba(255,255,255,.72);}'
      + 'body[data-ifx-enabled="1"] .card__view,body[data-ifx-enabled="1"] .full-start__poster,body[data-ifx-enabled="1"] .full-start-new__poster{overflow:hidden;border-radius:var(--ifx-card-radius);}'
      + 'body[data-ifx-enabled="1"][data-ifx-card-style="glass"] .card .card__view{box-shadow:var(--ifx-shadow);background:linear-gradient(180deg,rgba(255,255,255,.03),rgba(255,255,255,0));}'
      + 'body[data-ifx-enabled="1"][data-ifx-card-style="glass"] .card.focus .card__view,body[data-ifx-enabled="1"][data-ifx-card-style="glass"] .card.hover .card__view{transform:translateY(-3px) scale(1.01);}'
      + 'body[data-ifx-enabled="1"][data-ifx-card-style="poster"] .card .card__view::after{content:"";position:absolute;inset:0;background:linear-gradient(180deg,rgba(9,11,16,0) 20%,rgba(9,11,16,.16) 60%,rgba(9,11,16,.74) 100%);pointer-events:none;}'
      + 'body[data-ifx-enabled="1"][data-ifx-card-style="clean"] .card .card__view{box-shadow:none!important;border:1px solid var(--ifx-line);}'
      + 'body[data-ifx-enabled="1"][data-ifx-focus="1"] .card.focus .card__view,body[data-ifx-enabled="1"][data-ifx-focus="1"] .card.hover .card__view{box-shadow:0 0 0 1px var(--ifx-accent-edge),0 0 0 4px var(--ifx-accent-soft),var(--ifx-shadow);}'
      + 'body[data-ifx-enabled="1"][data-ifx-motion="off"] *{transition:none!important;animation:none!important;}'
      + 'body[data-ifx-enabled="1"] .ifx-card-stack,body[data-ifx-enabled="1"] .ifx-full-stack{position:absolute;display:flex;flex-direction:column;gap:6px;z-index:10;pointer-events:none;max-width:80%;}'
      + 'body[data-ifx-enabled="1"] .ifx-pos-top-right{top:12px;right:12px;align-items:flex-end;}'
      + 'body[data-ifx-enabled="1"] .ifx-pos-top-left{top:12px;left:12px;align-items:flex-start;}'
      + 'body[data-ifx-enabled="1"] .ifx-pos-bottom-right{bottom:12px;right:12px;align-items:flex-end;}'
      + 'body[data-ifx-enabled="1"] .ifx-pos-bottom-left{bottom:12px;left:12px;align-items:flex-start;}'
      ...
      + 'body[data-ifx-enabled="1"][data-ifx-minimal="1"] .ifx-chip{background:rgba(12,14,18,.78);backdrop-filter:none;box-shadow:none;}'
      + 'body[data-ifx-enabled="1"] .ifx-chip--accent{background:linear-gradient(135deg,var(--ifx-accent-soft),rgba(8,10,14,.82));border-color:var(--ifx-accent-edge);}'
      + 'body[data-ifx-enabled="1"] .ifx-chip--subtle{color:var(--ifx-text-soft);}'
      + 'body[data-ifx-enabled="1"] .ifx-chip--good{background:rgba(33,138,78,.26);border-color:rgba(76,202,129,.44);}'
      + 'body[data-ifx-enabled="1"] .ifx-chip--warn{background:rgba(175,122,28,.26);border-color:rgba(246,194,88,.44);}'
      + 'body[data-ifx-enabled="1"] .ifx-chip--bad{background:rgba(155,54,62,.26);border-color:rgba(248,102,112,.44);}'
      + 'body[data-ifx-enabled="1"] .ifx-chip--light{background:rgba(255,255,255,.78);color:#111;border-color:rgba(255,255,255,.88);}'
      + 'body[data-ifx-enabled="1"] .full-start__buttons,body[data-ifx-enabled="1"] .full-start-new__buttons{position:relative;gap:12px;}'
      + 'body[data-ifx-enabled="1"] .full-start__buttons .button,body[data-ifx-enabled="1"] .full-start-new__buttons .button,body[data-ifx-enabled="1"] .full-start__buttons .full-start__button,body[data-ifx-enabled="1"] .full-start-new__buttons .full-start__button{display:inline-flex;align-items:center;justify-content:center;min-height:54px;padding:0 22px;border-radius:20px;border:1px solid rgba(255,255,255,.10);background:linear-gradient(180deg,rgba(30,35,46,.92),rgba(15,18,26,.94));box-shadow:0 12px 30px rgba(0,0,0,.24);transition:transform .18s ease,box-shadow .18s ease,border-color .18s ease,background .18s ease,color .18s ease;color:#f5f7fb!important;}'
      + 'body[data-ifx-enabled="1"] .full-start__buttons .button > *,body[data-ifx-enabled="1"] .full-start-new__buttons .button > *,body[data-ifx-enabled="1"] .full-start__buttons .full-start__button > *,body[data-ifx-enabled="1"] .full-start-new__buttons .full-start__button > *{color:inherit!important;}'
      + 'body[data-ifx-enabled="1"] .full-start__buttons .button.focus,body[data-ifx-enabled="1"] .full-start-new__buttons .button.focus,body[data-ifx-enabled="1"] .full-start__buttons .full-start__button.focus,body[data-ifx-enabled="1"] .full-start-new__buttons .full-start__button.focus,body[data-ifx-enabled="1"] .full-start__buttons .button.hover,body[data-ifx-enabled="1"] .full-start-new__buttons .button.hover,body[data-ifx-enabled="1"] .full-start__buttons .full-start__button.hover,body[data-ifx-enabled="1"] .full-start-new__buttons .full-start__button.hover{transform:translateY(-2px);border-color:rgba(132,212,255,.72);background:linear-gradient(180deg,rgba(42,56,78,.98),rgba(20,28,42,.98));box-shadow:0 0 0 3px rgba(86,194,255,.18),0 18px 34px rgba(0,0,0,.30);color:#ffffff!important;}'
      + 'body[data-ifx-enabled="1"] .full-start__buttons .button.selector.focus,body[data-ifx-enabled="1"] .full-start-new__buttons .button.selector.focus,body[data-ifx-enabled="1"] .full-start__buttons .full-start__button.selector.focus,body[data-ifx-enabled="1"] .full-start-new__buttons .full-start__button.selector.focus{color:#ffffff!important;}'
      + 'body[data-ifx-enabled="1"][data-ifx-compact="1"] .full-start__buttons .button,body[data-ifx-enabled="1"][data-ifx-compact="1"] .full-start-new__buttons .button,body[data-ifx-enabled="1"][data-ifx-compact="1"] .full-start__buttons .full-start__button,body[data-ifx-enabled="1"][data-ifx-compact="1"] .full-start-new__buttons .full-start__button{min-height:48px;padding:0 18px;border-radius:18px;}'
      + 'body[data-ifx-enabled="1"][data-ifx-layout="grid"] .full-start__buttons,body[data-ifx-enabled="1"][data-ifx-layout="grid"] .full-start-new__buttons{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr));align-items:stretch;}'
      + 'body[data-ifx-enabled="1"][data-ifx-layout="strip"] .full-start__buttons,body[data-ifx-enabled="1"][data-ifx-layout="strip"] .full-start-new__buttons{display:flex!important;flex-wrap:nowrap!important;overflow-x:auto!important;overflow-y:hidden!important;padding-bottom:6px;}'
      + 'body[data-ifx-enabled="1"][data-ifx-layout="strip"] .full-start__buttons::-webkit-scrollbar,body[data-ifx-enabled="1"][data-ifx-layout="strip"] .full-start-new__buttons::-webkit-scrollbar{height:6px;}'
      + 'body[data-ifx-enabled="1"][data-ifx-layout="strip"] .full-start__buttons .button,body[data-ifx-enabled="1"][data-ifx-layout="strip"] .full-start-new__buttons .button,body[data-ifx-enabled="1"][data-ifx-layout="strip"] .full-start__buttons .full-start__button,body[data-ifx-enabled="1"][data-ifx-layout="strip"] .full-start-new__buttons .full-start__button{flex:0 0 auto;}'
      + 'body[data-ifx-enabled="1"] .ifx-rate-pill{display:inline-flex;align-items:center;justify-content:center;min-width:44px;padding:4px 10px;border-radius:999px;background:rgba(7,10,14,.72);border:1px solid rgba(255,255,255,.08);box-shadow:0 10px 26px rgba(0,0,0,.18);}'
      + 'body[data-ifx-enabled="1"][data-ifx-rating-view="clean"] .ifx-rate-pill{padding:0;min-width:0;background:none;border:0;box-shadow:none;}'
      + 'body[data-ifx-enabled="1"] .ifx-status-good{color:#86f1ab!important;}'
      + 'body[data-ifx-enabled="1"] .ifx-status-warn{color:#ffd36d!important;}'
      + 'body[data-ifx-enabled="1"] .ifx-status-bad{color:#ff8a8a!important;}'
      + 'body[data-ifx-enabled="1"] .ifx-meta-inline{display:flex;flex-wrap:wrap;gap:8px;margin-top:12px;}'
      + 'body[data-ifx-enabled="1"] .ifx-meta-inline .ifx-chip{pointer-events:none;}';
  }
