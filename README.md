...
Коллекция пользовательских плагинов для Lampa.

## Подключение

- `https://jefrexon-blip.github.io/lampa-plugins/atelier.js`
...
- `atelier.js` — визуальная переработка карточек и full-card.
